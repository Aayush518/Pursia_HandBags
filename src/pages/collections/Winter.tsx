  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-light mb-2">Winter Essentials</h1>
          <p className="text-gray-600">Cozy and stylish winter collection</p>
        </div>
